...
const Complaints = () => {
  ...
  const { data: issues, isLoading, error } = useGetAllIssues();
    ...
    <>
      ...
      {complaints.length === 0 && !isLoading && (
        <div className="text-center py-12">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white">No complaints found</h2>
