...
const NewIssue = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            const submissionData = {
                ...values,
                locationData: selectedLocation // Include detailed location data
            };
            console.log("Submitted issue : ", submissionData);
    ...
    const handleMapLocationSelect = (locationData) => {
        ...
        formik.setFieldValue("location", locationData.address || locationData.coordinates);
    };
            ...
            <div className="flex min-h-screen items-center justify-center bg-gradient-to-tr from-indigo-500 via-violet-500 to-pink-500 p-5">
                            ...
                            <div className="mb-2">
                                ...
                                <div className="flex flex-wrap gap-2 mb-2">
                                    ...
                                    <button
                                        ...
                                        className="rounded-xl bg-green-500 px-4 py-2 text-sm font-semibold whitespace-nowrap text-white transition hover:bg-green-600"
                                    >
                                        Select from Map
                                    </button>
                                    <span className="flex items-center text-sm text-slate-600">or</span>
                                </div>
                                <input
                                    type="text"
                                    name="location"
                                    ...
                                    className="w-full rounded-xl border border-slate-300 px-4 py-2 transition outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200"
                                />
                                {selectedLocation && (
                ...
                {showMapPicker && (
                    <MapLocationPicker
                        ...
                        initialPosition={selectedLocation ? [selectedLocation.latitude, selectedLocation.longitude] : null}
                    />
                )}
            </div>
        </>
